...
<div class="content">
    ...
    <div class="content_top">&nbsp;&nbsp;&nbsp;现在的位置为：文章管理-&gt;</div>
    ...
    <div class="m_content">
        ...
        <div class="real_c">
          ...
          <form action="/Admin/Article/showList" method="get" class="form" name="search" id="list-form">
              ...
              <select onchange="do_select(this)" class="level-type"  id="level-type_order">
				...
				<table class="table_content">
                  ...
                  <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="tr_list">
                    ...
                    <a href="/Admin/Article/edit?act=edit&id=<?php echo ($vo["id"]); ?>" >编辑</a> |
                    <a href="javascript:void(0)" onclick="delarticle()">恢复</a> |
                    <a href="/Admin/Article/showList?act=del&id=<?php echo ($vo["id"]); ?>&p=<?php echo ($_GET['p']); ?>" id="a_del" onclick="return delAlert()">删除</a>
                    </td>  
...
function delAlert(){
  var bool = window.confirm("你确定要删除文章吗？");
