...
<div class="content">
    ...
    <div class="content_top">&nbsp;&nbsp;&nbsp;现在的位置为：分类-&gt;分类添加</div>
    <div class="m_content">
        ...
        <div class="real_c">
            ...
            <form name="category_add" method="post" action="/admin/category/add?act=add">
            <table border="0" cellpadding="0" cellspacing="0" id="add_table" width="100%">
                <tr>
                    <td class="left_td">分类名称：</td>
                    <td class="right_td"><input type="text" name="cat[category]" class="input"  /></td>
                </tr>
                
                <tr>
                    <td class="left_td">相关描述：</td>
                    <td class="right_td"><textarea name="cat[description]" style="border:1px #D3D3D3 solid;border-radius:3px;margin:2px 0;" cols="30" rows="8"></textarea></td>
                </tr>
                ...
                <tr><td colspan="4" valign="bottom" align="center"><div class="formHandleBox" style="padding-left:100px;">
                    ...
                    <a onclick="form_submit(); return false;" class="eventlink">添加分类</a>
                </div></td></tr>
            </table>
            </form>
            </div>
