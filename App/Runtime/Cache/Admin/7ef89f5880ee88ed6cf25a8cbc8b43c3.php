...
<div class="content">
    ...
    <div class="m_content">
        ...
        <div class="real_c">
          ...
          <form action="/index.php/Admin/Goods/showList" method="get" class="form" name="search" id="list-form">
              ...
              <select onchange="do_select(this)" class="level-type"  id="level-type_order">
				...
				<table class="table_content">
                  ...
                  <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="tr_list">
                    ...
                    <a href="/index.php/Admin/Goods/edit?act=edit&id=<?php echo ($vo["goods_id"]); ?>" >编辑</a> |
                    <a href="javascript:void(0)" onclick="delarticle()">恢复</a> |
                    <a href="/index.php/Admin/Goods/showList?act=del&id=<?php echo ($vo["id"]); ?>&p=<?php echo ($_GET['p']); ?>" id="a_del" onclick="return delAlert()">删除</a>
                    </td>  
