...
<html>
	...
	<head>
		...
		<link href="/Public/css/vipstyle.css" rel="stylesheet" type="text/css">
	...
	<body>
					...
					<div class="wrap-left">
						<div class="wrap-list">
							<div class="m-user">
								...
								<div class="m-userinfo">
									...
									<div class="m-baseinfo">
										<a class="m-pic" href="/index.php/Home/Person/information">
											<img src="/Public/images/getAvatar.do.jpg">
										</a>
										<div class="m-info">
											<em class="s-name"><?php echo (session('username')); ?></em>
								...
								<div class="wallet">
									...
									<p class="m-big squareS">
										<a href="#">
											<i><img src="/Public/images/shopping.png"/></i>
											<span class="m-title">能购物</span>
										</a>
									</p>
									<p class="m-big squareA">
										<a href="#">
											<i><img src="/Public/images/safe.png"/></i>
											<span class="m-title">够安全</span>
										</a>
									</p>
									<p class="m-big squareL">
										<a href="#">
											<i><img src="/Public/images/profit.png"/></i>
							...
							<div class="m-order">
								...
								<ul>
									<li><a href="order.html"><i><img src="/Public/images/pay.png"/></i><span>待付款</span></a></li>
									<li><a href="order.html"><i><img src="/Public/images/send.png"/></i><span>待发货<em class="m-num">1</em></span></a></li>
									<li><a href="order.html"><i><img src="/Public/images/receive.png"/></i><span>待收货</span></a></li>
									<li><a href="order.html"><i><img src="/Public/images/comment.png"/></i><span>待评价<em class="m-num">3</em></span></a></li>
									<li><a href="change.html"><i><img src="/Public/images/refund.png"/></i><span>退换货</span></a></li>
								</ul>
								<div class="orderContentBox">
									<div class="orderContent">
										<div class="orderContentpic">
											<div class="imgBox">
												<a href="orderinfo.html"><img src="/Public/images/youzi.jpg"></a>
											</div>
										</div>
								...
								<div class="orderContentBox">
									<div class="orderContent">
										<div class="orderContentpic">
											<div class="imgBox">
												<a href="orderinfo.html"><img src="/Public/images/heart.jpg"></a>
											</div>
										</div>
										<div class="detailContent">
								...
								<div class="twoTabModel credit">
									...
									<div class="Box">
										...
										<div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:108, itemMargin:3, slideshow: false}">
											<ul class="am-slides">
												<li><a href="#"><img src="/Public/images/333.jpg" /></a></li>
												<li><a href="#"><img src="/Public/images/222.jpg" /></a></li>
												<li><a href="#"><img src="/Public/images/111.jpg" /></a></li>
												<li><a href="#"><img src="/Public/images/333.jpg" /></a></li>
												<li><a href="#"><img src="/Public/images/222.jpg" /></a></li>
												<li><a href="#"><img src="/Public/images/111.jpg" /></a></li>
											</ul>
						...
						<div class="new-goods">
							...
							<div class="new-goods-info">
								<a class="shop-info" href="#" target="_blank">
									<div >
										<img src="/Public/images/666.jpg" alt="">
									</div>
                        ...
                        <div class="am-tabs-bd">
                            ...
                            <div data-tab-panel-0 class="am-tab-panel am-active">
                        		<div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:155,slideshow: false}">
									<ul class="am-slides">
                                       <li>
                                       	  <a><img class="am-thumbnail" src="/Public/images/EZA27501.jpg" /></a>
                                       	  <strong class="price">¥32.9</strong>
                                       </li>
                                       <li>
                                       	  <a><img class="am-thumbnail" src="/Public/images/BxJk6.jpg" /></a>
                                       	  <strong class="price">¥32.9</strong>
                                       </li>
                                       <li>
                                       	  <a><img class="am-thumbnail" src="/Public/images/Hxcag60.jpg" /></a>
                                       	  <strong class="price">¥32.9</strong>
                                       </li>
                                       <li>
                                       	  <a><img class="am-thumbnail" src="/Public/images/youzi.jpg" /></a>
                                       	  <strong class="price">¥32.9</strong>
                                       </li>
                                       <li>
                                       	  <a><img class="am-thumbnail" src="/Public/images/EZA27501.jpg" /></a>
		...
		<!--引导 -->
		<div class="navCir">
			<li><a href="/Public/home/home2.html"><i class="am-icon-home "></i>首页</a></li>
			<li><a href="/Public/home/sort.html"><i class="am-icon-list"></i>分类</a></li>
			<li><a href="/Public/home/shopcart.html"><i class="am-icon-shopping-basket"></i>购物车</a></li>
