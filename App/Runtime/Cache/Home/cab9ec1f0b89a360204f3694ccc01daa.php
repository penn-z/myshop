                      ...
                      <!--轮播 -->
						<div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
							<ul class="am-slides">
								...
								<li class="banner2"><a href="/home/introduction?id=8&sn=1000011"><img src="/Public/images/ad6.jpg" /></a></li>
								...
								<div class="category-content" id="guide_2">
									...
									<div class="category" style="box-shadow:none ;margin-top: 2px;">
										<ul class="category-list navTwo" id="js_climit_li">
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/Public/images/meat.png"></i><a class="ml-22" title="熟食、肉类">熟食/肉类</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/Public/images/bamboo.png"></i><a class="ml-22" title="素食、卤味">素食/卤味</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/Public/images/nut.png"></i><a class="ml-22" title="坚果、炒货">坚果/炒货</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/Public/images/candy.png"></i><a class="ml-22" title="糖果、蜜饯">糖果/蜜饯</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/Public/images/chocolate.png"></i><a class="ml-22" title="巧克力">巧克力</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/Public/images/fish.png"></i><a class="ml-22" title="海味、河鲜">海味/河鲜</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li >
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/Public/images/tea.png"></i><a class="ml-22" title="花茶、果茶">花茶/果茶</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
											...
											<li>
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/Public/images/package.png"></i><a class="ml-22" title="品牌、礼包">品牌/礼包</a></h3>
													<em>&gt;</em></div>
												<div class="menu-item menu-in top">
													<div class="area-in">
														<div class="area-bg">
                     ...
                     <div class="sale-mt">
					  ...
					  <div class="am-g am-g-fixed sale">
						<div class="am-u-sm-3 sale-item">
							<div class="s-img">
								<a href="# "><img src="/Public/images/sale3.jpg" /></a>
							</div>
                           <div class="s-info">
						...
						<div class="am-u-sm-3 sale-item">
							<div class="s-img">
								<a href="# "><img src="/Public/images/sale2.jpg" /></a>
							</div>
                           <div class="s-info">
                           	   <a href="#"><p class="s-title">ZEK 原味海苔</p></a>
                           	   <div class="s-price">￥<b>9.90</b>
						...
						<div class="am-u-sm-3 sale-item">
							<div class="s-img">
								<a href="# "><img src="/Public/images/sale1.jpg" /></a>
							</div>
                           <div class="s-info">
                           	   <a href="#"><p class="s-title">ZEK 原味海苔</p></a>
                           	   <div class="s-price">￥<b>9.90</b>
            ...
            <div class="f1">
					...
					<div class="am-g am-g-fixed floodSix ">				
						...
						<div class="am-u-sm-7 am-u-md-5 am-u-lg-2 text-two big">
								...
								<a href="# "><img src="/Public/images/act1.png" /></a>						
						</div>
						...
						<div class="am-u-sm-4 am-u-md-5 am-u-lg-4 text-five">
							...
							<a href="# "><img src="/Public/images/5.jpg" /></a>
						</div>	
						</li>
						<li>
						<div class="am-u-sm-4 am-u-md-2 am-u-lg-2 text-six">
							...
							<a href="# "><img src="/Public/images/3.jpg" /></a>
						</div>	
						</li>
						<li>
						<div class="am-u-sm-4 am-u-md-2 am-u-lg-4 text-six">
							...
							<a href="# "><img src="/Public/images/4.jpg" /></a>
						</div>	
						</li>						
					</div>
					...
					<div class="am-g am-g-fixed floodSeven">
						<div class="am-u-sm-5 am-u-md-4 text-one list ">
							...
							<div class="am-u-sm-7 am-u-md-4 text-two big">
								...
								<a href="# "><img src="/Public/images/act2.png " /></a>
                        ...
                        <li>
							<div class="am-u-sm-7 am-u-md-4 text-two">
								...
								<a href="# "><img src="/Public/images/6.jpg" /></a>
							</div>
                        </li>
                        <li>
						<div class="am-u-sm-3 am-u-md-2 text-three sug">
							...
							<a href="# "><img src="/Public/images/7.jpg" /></a>
						</div>
                        </li>
                        <li>
						<div class="am-u-sm-3 am-u-md-2 text-three big">
							...
							<a href="# "><img src="/Public/images/10.jpg" /></a>
						</div>
                        </li>
                        <li>
						<div class="am-u-sm-3 am-u-md-2 text-three ">
							...
							<a href="# "><img src="/Public/images/8.jpg" /></a>
						</div>
                        </li>
                        <li>
						<div class="am-u-sm-3 am-u-md-2 text-three ">
							...
							<a href="# "><img src="/Public/images/9.jpg" /></a>
						</div>
						</li>
					</div>
                 <div class="clear "></div>                 
