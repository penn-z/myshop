				...
				<div class="main-wrap">
					...
					<div class="user-safety">
						...
						<div class="user-infoPic">
							...
							<div class="filePic">
								<img class="am-circle am-img-thumbnail" src="<?php echo ((isset($data) && ($data !== ""))?($data):'/Public/images/getAvatar.do.jpg'); ?>" alt="" />
							</div>
						...
						<div class="check">
							<ul>
								<li>
									...
									<div class="fore3">
										<a href="/home/information/password.html">
								...
								<li>
									...
									<div class="fore3">
										<a href="/home/information/question.html">
