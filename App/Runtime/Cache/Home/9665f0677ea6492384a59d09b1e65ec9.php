				...
				<div id="cartTable">
					...
					<tr class="item-list">
						<div class="bundle  bundle-last ">
							...
							<?php if(is_array($cart)): foreach($cart as $key=>$vo): ?><div class="common_father">
								<ul class="item-content clearfix">
									...
									<li class="td td-item">
										<div class="item-pic">
											<a href="#" target="_blank" data-title="<?php echo ($vo["goods_name"]); ?>" class="J_MakePoint" data-point="tbcart.8.12">
												<img style="width:100%;height:100%;" src="<?php echo ($vo["goods_thumb"]); ?>" class="itempic J_ItemImg"></a>
										</div>
										<div class="item-info">
											<div class="item-basic-info">
												<a href="#" target="_blank" title="<?php echo ($vo["goods_name"]); ?>" class="item-title J_MakePoint" data-point="tbcart.8.11"><?php echo ($vo["goods_name"]); ?></a>
											</div>
										</div>
									</li>
									<li class="td td-info">
										...
										<div class="item-price price-promo-promo">
											<div class="price-content">
												<div class="price-line">
													<em class="price-original"><?php echo ($vo["ori_price"]); ?></em>
												</div>
												<div class="price-line">
													<em class="J_Price price-now" tabindex="0"><?php echo ($vo["goods_cost"]); ?></em>
												</div>
											</div>
										</div>
									</li>
										...
										<div class="amount-wrapper ">
											<div class="item-amount ">
												<div class="sl">
													...
													<input class="text_box text_box_num" name="" type="text" value="<?php echo ($vo["goods_num"]); ?>" style="width:30px;" onblur="writeNum(this)" onfocus="prevNum(this)"/>
									...
									<div class="theme-popbod dform">
										<form class="theme-signin" name="loginform" action="" method="post">
											...
											<div class="theme-signin-left">
												...
												<div class="theme-options">
													...
													<dd>
														...
														<span  class="tb-hidden">库存<span class="stock"><?php echo ($vo["num"]["0"]); ?></span>件</span>
													</dd>
												...
												<div class="btn-op">
													...
													<input type="hidden" value="<?php echo ($vo["goods_id"]); ?>" id="goods_id" />
													<input type="hidden" value="<?php echo ($vo["cart_id"]); ?>" id="cart_id" />
												</div>
											...
											<div class="theme-signin-right" style="height:300px;">
												...
												<div class="text-info">
													<span class="J_Price price-now"><?php echo ($vo["discount"]["0"]); ?></span>
													<span id="Stock" class="tb-hidden">库存<span class="stock"><?php echo ($vo["num"]["0"]); ?></span>件</span>
												</div>
											</div>
										</form>
									</div>
