					...
					<div class="user-address">
						...
						<?php if(is_array($data)): foreach($data as $key=>$vo): if(($vo["is_default"]) == "1"): ?><li class="user-addresslist defaultAddr">
									...
									<div class="new-addr-btn">
										<a href="/home/information/editAddress?act=edit&id=<?php echo ($vo["id"]); ?>"><i class="am-icon-edit"></i>编辑</a>
						...
						<div class="am-modal am-modal-no-btn" id="doc-modal-1">
							...
							<div class="add-dress">
								...
								<div class="am-u-md-12 am-u-lg-8" style="margin-top: 20px;">
									<form class="am-form am-form-horizontal" id="add" action="/home/information/saveEdit?id=<?php echo ($single["id"]); ?>" method="post">
...
<script src="/Public/js/address/distpicker.js"></script>
										...
										<div class="am-form-group">
											<div class="am-u-sm-9 am-u-sm-push-3">
												<a class="am-btn am-btn-danger" onclick="sub()">修改</a>
