	...
	<body>
		...
		<div class="login-banner">
			<div class="login-main">
				...
				<div class="login-box">
						...
						<div class="login-form">
						  <form method="post" action="/index.php/Home/Login/login" id="login_form">
							   <div class="user-name">
            ...
            <div class="login-links">
                <label for="remember-me"><input id="remember-me" type="checkbox" name="is_rem" <?php echo (cookie('checked')); ?> >记住密码</label>
